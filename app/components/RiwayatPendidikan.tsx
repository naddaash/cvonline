...
export default function RiwayatPendidikan() {
    return (
        ...
        <RowRiwayat jenjang="SD" sekolah="SDN TENJOLAYA" tahun="2011" />
        <RowRiwayat jenjang="SMP" sekolah="SMP PGRI CICALENGKA" tahun="2016" />
        <RowRiwayat jenjang="SMK" sekolah="SMK MA'ARIF TERPADU CICALENGKA" tahun="2019" />
